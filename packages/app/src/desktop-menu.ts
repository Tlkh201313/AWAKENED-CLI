...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Awakened Documentation", href: "https://awakened.ai/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/awakened" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/Tlkh201313/AWAKENED-CLI/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/Tlkh201313/AWAKENED-CLI/issues/new?template=bug_report.yml",
      },
    ],
  },
]
