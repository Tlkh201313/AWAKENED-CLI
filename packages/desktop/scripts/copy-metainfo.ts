...
const appId = channel === "prod" ? "ai.awakened.desktop" : `ai.awakened.desktop.${channel}`
const productName = channel === "prod" ? "Awakened" : `Awakened ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      Awakened is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
